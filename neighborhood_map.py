...
class NeighborhoodMap:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'NeighborhoodMap_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&NeighborhoodMap')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('NeighborhoodMap', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/neighborhood_map/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'NeighborhoodMap'),
            callback=self.run,
